...
function buildConfigPage(s) {
  ...
  return [
    ...
    'input[type=range]{width:100%;margin-top:6px;accent-color:#00ffff}',
    '.gval{color:#00ffff;font-weight:bold;float:right}',
    ...
    '<div class="card">',
    '<div class="lbl">Daily Step Goal <span class="gval" id="gv">' + goal + '</span></div>',
    '<input type="range" id="goal" min="1000" max="30000" step="500" value="' + goal + '" ',
    ...
    '    StepGoal:  +document.getElementById("goal").value,',
