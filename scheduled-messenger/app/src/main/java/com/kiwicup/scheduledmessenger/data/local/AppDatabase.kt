...
@Database(
    ...
    // 2: sms_messages.isRead. Every bump needs a Migration in [Migrations] — see DatabaseModule for
    // why a missing one now fails loudly instead of wiping the database.
    version = 2,
    exportSchema = false
)
